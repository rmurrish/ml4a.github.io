...
header_text: "“Seja muito desejado, quando os processos matematicais passavem atraves do cerebro humano em ves do mechanismo inanimado, sejava egualmente necessario que o razao por tras dos operacoes tomava um lugar tao claro e bem definitivo como o asunto do analismo, um ingrediente fundamental pero independente no ciencia, que e presciso no estudo do maquina.” <a href=\"https://books.google.de/books?id=b8YUDAAAQBAJ&pg=PA16&lpg=PA16\">Sketch of the Analytical Engine (1843), Ada Lovelace</a>"
---
...
Quase um século antes do conceção de redes neurais, [Ada Lovelace](http://findingada.com/) descreveu uma ambição de construir um  "[cálculo do sistema nervoso](http://www.thelancet.com/journals/lancet/article/PIIS0140-6736(15)00686-8/fulltext?rss=yes)." Embora analogieas especulativas entre os cérebros e as máquinas sao tao velho como filosofia de compução mesmo, nao era ate o professor de Ada [Charles Babbage](https://en.wikipedia.org/wiki/Charles_Babbage) propôs o  [mecanismo analítico](https://en.wikipedia.org/wiki/Analytical_Engine) que concebemos "calculadoras" com capacidades cognitivas humanas. Ada não viveria ver seu sonho de construir o mecanismo, pois os enginheiros da epoca não eram capaz de produzir os circuitos complexos requiridos por seus esquemas. No entanto, a idéia passou para o proximo século, quando [Alan Turing](https://en.wikipedia.org/wiki/Alan_Turing) a citou como a inspiraçáo para o jogo de imitação [Joho de Imitação](http://phil415.pbworks.com/f/TuringComputing.pdf), que logo era chamado o "[Teste de Turing](https://en.wikipedia.org/wiki/Turing_test)." Seus ruminações nos limites extreos da computaão iniciaram a primeira onda de da inteligência artificial, preparando o cenário para a primeira epoca dourada das redes neurais.

## Nacimento e Renascimento de Redes Neurais

O ressurgimento recente de redes neurais tem uma história particular. Pertamente connectado aos dias initiais de AI (Inteligência Artificial), redes neurais eram formalizadas no final da década de 1940 na forma de [B-type machines](https://en.wikipedia.org/wiki/Unorganized_machine) de Turing, com basas em pesuisas no [plasticidade sináptica](https://en.wikipedia.org/wiki/Hebbian_theory) por neurocientistas e psicólogos cognitivos que estudavam o processo de aprendimento humano. Enquanto a mecânica do cerebro estava sendo descoberta, cientistas da computação experimentavam com versões idealizadas de potential de ações e propagação para traz para simular o process em máquinas.

Hoje em dia, a maioria das cientistas tomam quidado de não tomar essa analogia com gravidade demais, portanto as redes neurais são desenhadas somente para solvar problemas de aprendimento máquinal, em vez de explicar o cerebro com precisão, enquanto um campo de estudo bem separado chamado de [neurociençia de computação](https://en.wikipedia.org/wiki/Computational_neuroscience) tem o desafio de modelar o cerebro fielmente. Portanto, o metáfora do unidade fundamental das redes neurais como um modelo simplificado biologico ficou atraves as decadas. O progresso de neurônios biologicos para os artificiais pode ser sumarizada nas figuras siguintes.
